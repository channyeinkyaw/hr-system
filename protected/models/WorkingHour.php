 ...
 *
 * The followings are the available columns in table 'working_hour':
 * @property integer $ID
...
class WorkingHour extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('personal_id, working_date, start_time, end_time', 'required'),
			array('personal_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ID, personal_id, working_date, start_time, end_time', 'safe', 'on'=>'search'),
		);
	}
